...
{
    uint8 staticBits = (PWM_3_DR & (uint8)(~PWM_3_MASK));
    PWM_3_DR = staticBits | ((uint8)(value << PWM_3_SHIFT) & PWM_3_MASK);
}
...
{
	CyPins_SetPinDriveMode(PWM_3_0, mode);
}
...
{
    return (PWM_3_PS & PWM_3_MASK) >> PWM_3_SHIFT;
}
...
{
    return (PWM_3_DR & PWM_3_MASK) >> PWM_3_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(PWM_3_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & PWM_3_0_INTR) != 0u) 
		{ 
			 PWM_3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (PWM_3_INTSTAT & PWM_3_MASK) >> PWM_3_SHIFT;
    }
