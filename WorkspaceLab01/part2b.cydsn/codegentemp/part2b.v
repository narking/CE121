// ======================================================================
// part2b.v generated from TopDesign.cysch
// 04/18/2019 at 23:59
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5ca9ff28-12b9-4382-9c11-3930033cbea0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=2, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=5, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=8, RunMode=1, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_2, CY_INSTANCE_SHORT_NAME=Counter_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter_2, )
...
// SleepTimer_v3_20(EnableInt=true, Interval=9, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SleepTimer_v3_20, CY_CONFIG_TITLE=SleepTimer_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SleepTimer_1, CY_INSTANCE_SHORT_NAME=SleepTimer_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SleepTimer_1, )
...
module top ;
    ...
    CyControlReg_v1_80 Control_Reg_1 (
        ...
        .clock(Net_182),
        .reset(Net_85));
    defparam Control_Reg_1.Bit0Mode = 1;
    ...
    CyControlReg_v1_80 Control_Reset (
        .control_1(Net_14),
        .control_2(Net_15),
        .control_3(Net_16),
        .control_0(Net_99),
        ...
        .clock(Net_182),
        .reset(1'b0));
    defparam Control_Reset.Bit0Mode = 3;
    defparam Control_Reset.Bit1Mode = 0;
    defparam Control_Reset.Bit2Mode = 0;
    defparam Control_Reset.Bit3Mode = 0;
    defparam Control_Reset.Bit4Mode = 0;
    defparam Control_Reset.Bit5Mode = 0;
    defparam Control_Reset.Bit6Mode = 0;
    defparam Control_Reset.Bit7Mode = 0;
    defparam Control_Reset.BitValue = 0;
    defparam Control_Reset.BusDisplay = 0;
    defparam Control_Reset.ExtrReset = 1;
    defparam Control_Reset.NumOutputs = 1;


	cy_clock_v1_0
		#(.id("b4e55aac-28df-4b1b-b62a-788ebd47af31"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
    ...
    CyControlReg_v1_80 Control_Timer_Reset (
        .control_1(Net_28),
        .control_2(Net_29),
        .control_3(Net_30),
        .control_0(Net_174),
        ...
        .clock(Net_182),
        .reset(1'b0));
    defparam Control_Timer_Reset.Bit0Mode = 3;
    defparam Control_Timer_Reset.Bit1Mode = 0;
    defparam Control_Timer_Reset.Bit2Mode = 0;
    defparam Control_Timer_Reset.Bit3Mode = 0;
    defparam Control_Timer_Reset.Bit4Mode = 0;
    defparam Control_Timer_Reset.Bit5Mode = 0;
    defparam Control_Timer_Reset.Bit6Mode = 0;
    defparam Control_Timer_Reset.Bit7Mode = 0;
    defparam Control_Timer_Reset.BitValue = 0;
    defparam Control_Timer_Reset.BusDisplay = 0;
    defparam Control_Timer_Reset.ExtrReset = 1;
    defparam Control_Timer_Reset.NumOutputs = 1;
	...
	cy_clock_v1_0
		#(.id("a8646219-54db-47f2-8e11-3daa6d3a2f4a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0f57a072-4cec-4c4a-ab48-de672218b7a9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("8c3d8e5a-566f-4854-9712-71efaee90bf9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1E+15"),
		  .is_direct(0),
    ...
    CyControlReg_v1_80 LED_Reset (
        ...
        .clock(Net_182),
        .reset(1'b0));
    defparam LED_Reset.Bit0Mode = 3;
    defparam LED_Reset.Bit1Mode = 0;
    defparam LED_Reset.Bit2Mode = 0;
    defparam LED_Reset.Bit3Mode = 0;
    defparam LED_Reset.Bit4Mode = 0;
    defparam LED_Reset.Bit5Mode = 0;
    defparam LED_Reset.Bit6Mode = 0;
    defparam LED_Reset.Bit7Mode = 0;
    defparam LED_Reset.BitValue = 0;
    defparam LED_Reset.BusDisplay = 0;
    defparam LED_Reset.ExtrReset = 1;
    defparam LED_Reset.NumOutputs = 1;
    ...
    SleepTimer_v3_20_4 SleepTimer_1 (
        .interrupt(Net_56));
